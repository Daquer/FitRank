...
/**
 * Servlet implementation class AtualizaUrlPerfilPessoa
 */
@WebServlet("/AtualizaUrlPerfilPessoa")
public class AtualizaUrlPerfilPessoa extends HttpServlet {
	...
	private void inicia(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String urlPerfil = request.getAttribute("url") == null ? (String) request.getParameter("url") : (String) request.getAttribute("url");
